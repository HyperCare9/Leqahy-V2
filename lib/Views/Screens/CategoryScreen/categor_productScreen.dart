...
import 'package:leqahy_v2/Model/menu_model/menu_product_model.dart';
import 'package:leqahy_v2/Services/Menu_Services/menu_services.dart';
import 'package:leqahy_v2/Views/Screens/CategoryScreen/categoryDetails.dart';
      ...
      body: Column(
        ...
        children: [
          homeVM.buildAppBar(
              ...
              companyName: widget.categoryName,
          ...
          companyName(size: size, companyName: widget.categoryName),
          SizedBox(height: size.height * 0.02),
          Expanded(
            child: FutureBuilder<List<MenuProductModel>>(
                future: MenuAPI().getProductByCategory(
                    categoryID: widget.categoryID,
