...
import 'package:leqahy_v2/Model/Product_model/product_description_model.dart';
import 'package:leqahy_v2/Model/Product_model/product_details_Model.dart';
import 'package:leqahy_v2/Model/Product_model/product_images_model.dart';
import 'package:leqahy_v2/Services/Prdouct_Services/productAPI.dart';
                ...
                if (widget.isCart == true) {
                  Navigator.of(context).pushReplacement(MaterialPageRoute(
                      builder: (_) => CardScreen(
                          isProduct: false, isProductCategory: false)));
                } else {
                  Navigator.of(context).pushReplacement(MaterialPageRoute(
